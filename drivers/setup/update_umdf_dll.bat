...
chcp 65001 >nul 2>&1
:: 需要管理员权限运行
:: 将已签名的 OpenCertFIDODriver.dll 复制到 UMDF 目录并重新触发设备加载
...
set "SRC=G:\Codes\GlobalTrusts\PKCS11Driver\drivers\build\OpenCertFIDODriver.dll"
set "DST=C:\Windows\System32\drivers\UMDF\OpenCertFIDODriver.dll"
