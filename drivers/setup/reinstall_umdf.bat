...
echo [5/6] 创建设备节点...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%UMDF_PS1%" -InfFile "%BUILD_DIR%\OpenCertFIDODriver.inf"
echo.
...
"C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\bin\Hostx64\x64\dumpbin.exe" /dependents "%UMDF_DIR%\OpenCertFIDODriver.dll" 2>&1
